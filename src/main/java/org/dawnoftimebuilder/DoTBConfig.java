    ...
    static{
        ...
        COMMON_BUILDER.comment("---------------------------------------|| Block settings ||----------------------------------------").push(BLOCK_CATEGORY);
            ...
            COMMON_BUILDER.push("climbing_plant");
                CLIMBING_PLANT_GROWTH_CHANCE = COMMON_BUILDER.comment("The probability to grow is equal to 1/x, with x the following value :").defineInRange("climbingPlantGrowthChance", 16, 1, 200);
        ...
        COMMON_BUILDER.comment("----------------------------------|| World generation settings ||----------------------------------").push(WORLD_GENERATION_CATEGORY);
            COMMON_BUILDER.push("camellia");
                CAMELLIA_GENERATION = COMMON_BUILDER.comment("List of biomes where this plant should spawn during world generation :").defineList("camelliaGeneration", Arrays.asList("minecraft:flower_forest", "minecraft:jungle", "minecraft:jungle_hills", "minecraft:jungle_edge"), obj -> true);
            ...
            COMMON_BUILDER.push("cypress");
                CYPRESS_GENERATION = COMMON_BUILDER.comment("Must spawn this plant during world generation :").define("cypressGeneration", Arrays.asList("minecraft:flower_forest", "minecraft:taiga", "minecraft:taiga_hills", "minecraft:giant_tree_taiga", "minecraft:giant_tree_taiga_hills", "minecraft:giant_spruce_taiga", "minecraft:giant_spruce_taiga_hills"), obj -> true);
            ...
            COMMON_BUILDER.pop();
            COMMON_BUILDER.push("mulberry");
                MULBERRY_GENERATION = COMMON_BUILDER.comment("Must spawn this plant during world generation :").define("mulberryGeneration", Arrays.asList("minecraft:flower_forest", "minecraft:taiga", "minecraft:taiga_hills", "minecraft:giant_tree_taiga", "minecraft:giant_tree_taiga_hills", "minecraft:giant_spruce_taiga", "minecraft:giant_spruce_taiga_hills"), obj -> true);
            ...
            COMMON_BUILDER.push("rice");
                RICE_GENERATION = COMMON_BUILDER.comment("Must spawn this plant during world generation :").define("riceGeneration", Arrays.asList("minecraft:swamp", "minecraft:river", "minecraft:swamp_hills"), obj -> true);
            ...
            COMMON_BUILDER.push("wild_grape");
                WILD_GRAPE_GENERATION = COMMON_BUILDER.comment("Must spawn this plant during world generation :").define("wildGrapeGeneration", Arrays.asList("minecraft:flower_forest", "minecraft:tall_birch_forest", "minecraft:tall_birch_hills", "minecraft:birch_forest", "minecraft:birch_forest_hills"), obj -> true);
            ...
            COMMON_BUILDER.push("wild_maize");
                WILD_MAIZE_GENERATION = COMMON_BUILDER.comment("Must spawn this plant during world generation :").define("wildMaizeGeneration", Arrays.asList("minecraft:flower_forest", "minecraft:savanna", "minecraft:savanna_plateau", "minecraft:shattered_savanna", "minecraft:shattered_savanna_plateau"), obj -> true);
            ...
            COMMON_BUILDER.push("commelina");
                COMMELINA_GENERATION = COMMON_BUILDER.comment("Must spawn this plant during world generation :").define("commelinaGeneration", Arrays.asList("minecraft:flower_forest", "minecraft:swamp", "minecraft:swamp_hills"), obj -> true);
