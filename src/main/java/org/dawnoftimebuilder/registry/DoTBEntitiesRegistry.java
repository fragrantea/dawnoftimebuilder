...
public class DoTBEntitiesRegistry {
	...
	public static final RegistryObject<EntityType<ChairEntity>> CHAIR_ENTITY = reg("chair", EntityType.Builder.<ChairEntity>of((type, world) -> new ChairEntity(world), MobCategory.MISC).sized(0.0F, 0.0F).setCustomClientFactory((spawnEntity, world) -> new ChairEntity(world)));
	...
	public static final RegistryObject<EntityType<JapaneseDragonEntity>> JAPANESE_DRAGON_ENTITY = reg("japanese_dragon", EntityType.Builder.<JapaneseDragonEntity>of((type, world) -> new JapaneseDragonEntity(world), MobCategory.CREATURE).sized(1.0F, 1.0F).setCustomClientFactory((spawnEntity, world) -> new JapaneseDragonEntity(world)));
